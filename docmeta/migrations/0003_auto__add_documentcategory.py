...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'docmeta_documentcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['docmeta.DocumentCategory'])),
        ...
        db.send_create_signal(u'docmeta', ['DocumentCategory'])

        # Adding M2M table for field categories on 'Document'
        m2m_table_name = db.shorten_name(u'docmeta_document_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('document', models.ForeignKey(orm[u'docmeta.document'], null=False)),
            ('documentcategory', models.ForeignKey(orm[u'docmeta.documentcategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['document_id', 'documentcategory_id'])


    def backwards(self, orm):
        # Deleting model 'DocumentCategory'
        db.delete_table(u'docmeta_documentcategory')

        # Removing M2M table for field categories on 'Document'
        db.delete_table(db.shorten_name(u'docmeta_document_categories'))
