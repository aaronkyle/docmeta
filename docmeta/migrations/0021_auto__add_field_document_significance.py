...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.significance'
        db.add_column(u'docmeta_document', 'significance',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.significance'
        db.delete_column(u'docmeta_document', 'significance')
    ...
    models = {
        ...
        u'docmeta.document': {
            ...
            'date_received': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'blank': 'True'}),
            ...
            'significance': ('mezzanine.core.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}),
