...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'docmeta_documentcategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=512))

        # Changing field 'DocumentCategory.slug'
        db.alter_column(u'docmeta_documentcategory', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=512))
        # Adding unique constraint on 'DocumentCategory', fields ['parent', 'name']
        db.create_unique(u'docmeta_documentcategory', ['parent_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'DocumentCategory', fields ['parent', 'name']
        db.delete_unique(u'docmeta_documentcategory', ['parent_id', 'name'])


        # Changing field 'DocumentCategory.name'
        db.alter_column(u'docmeta_documentcategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'DocumentCategory.slug'
        db.alter_column(u'docmeta_documentcategory', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
