...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.source_file'
        db.alter_column(u'docmeta_document', 'source_file', self.gf('django.db.models.fields.files.FileField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'Document.source_file'
        db.alter_column(u'docmeta_document', 'source_file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
