...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DocumentFileName'
        db.create_table(u'docmeta_documentfilename', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['docmeta.Document'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=512)),
        ))
        db.send_create_signal(u'docmeta', ['DocumentFileName'])

        # Adding unique constraint on 'DocumentFileName', fields ['document', 'name']
        db.create_unique(u'docmeta_documentfilename', ['document_id', 'name'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'DocumentFileName', fields ['document', 'name']
        db.delete_unique(u'docmeta_documentfilename', ['document_id', 'name'])

        # Deleting model 'DocumentFileName'
        db.delete_table(u'docmeta_documentfilename')
