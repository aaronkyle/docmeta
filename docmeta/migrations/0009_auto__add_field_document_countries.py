...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.countries'
        db.add_column(u'docmeta_document', 'countries',
    ...
    def backwards(self, orm):
        # Deleting field 'Document.countries'
        db.delete_column(u'docmeta_document', 'countries')
